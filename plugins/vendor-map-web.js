...
function appJs() {
  ...
  function orderHtml(o){ const left = escapeHtml((o.quantity || 0) + '× ' + o.itemName + (o.itemBlueprint ? ' BP' : '')); const right = escapeHtml((o.cost || 0) + '× ' + o.currencyName + (o.currencyBlueprint ? ' BP' : '')); return '<div class="order ' + (o.inStock ? '' : 'out') + '"><div class="item"><b>' + squareIcon(o) + '<span>' + left + '</span></b></div><div class="arrow">for</div><div class="item"><b>' + squareIcon({ itemIcon:o.currencyIcon, itemCategory:o.itemCategory, inStock:o.inStock }) + '<span>' + right + '</span></b></div></div>'; }
