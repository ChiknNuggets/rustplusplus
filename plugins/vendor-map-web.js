...
<body>
  ...
  <main class="layout">
    ...
    <section class="map-panel" data-mobile-panel="map">
      <div class="map-help">Mouse wheel / pinch to zoom · Drag to pan · Click a marker for details</div><div class="draw-overlay"><button id="toggleDrawOverlay" class="btn">✏️</button><button id="toggleEraserOverlay" class="btn">🩹</button></div>
...
function appJs() {
  ...
  function toggleDrawMode(){ state.drawMode = !state.drawMode; if (!state.drawMode) state.eraserMode = false; syncDrawButtons(); }
