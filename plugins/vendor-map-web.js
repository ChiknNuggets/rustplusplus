...
function appJs() {
  ...
  function addMarker(vendor, onclick){
    ...
    const markerFace = vendor.type === 'vending' ? markerImageHtml(VENDING_MACHINE_MARKER_IMAGE, 'Vending machine') : (vendor.avatarUrl ? '' : icon(vendor));
  ...
  function markerImageHtml(src, alt){
    return '<img class="marker-image" src="' + src + '" alt="' + escapeHtml(alt || 'Marker') + '" draggable="false" />';
  }
