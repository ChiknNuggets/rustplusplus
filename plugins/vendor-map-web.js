...
const VENDING_MARKER_IMAGE_DATA = 'data:image/png;base64,';
const VENDING_CLUSTER_MARKER_IMAGE_DATA = 'data:image/png;base64,';
...
function appJs() {
  ...
  function addClusterMarker(cluster){
    ...
    el.innerHTML = '<span class="cluster-count">' + cluster.vendors.length + '</span>' + clusterPopoverHtml(cluster);
  ...
  function addMarker(vendor, onclick){
    ...
    el.innerHTML = ((vendor.avatarUrl || vendor.type === 'vending') ? '' : icon(vendor)) + '<span class="marker-label">' + escapeHtml(shortLabel(vendor)) + '</span>' + (vendor.type === 'vending' ? vendorPopoverHtml(vendor) : '');
